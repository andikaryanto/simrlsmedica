...
class FrontOffice extends MY_Controller {
    ...
    public function index(){
        redirect('FrontOffice/listFrontOffice');
    }

    public function listFrontOffice() {
        $data['listFrontOffice'] = $this->FrontOfficeModel->listFrontOffice();
        $this->template->view('master/front_office/list_front_office_v',$data);
    }
    ...
    public function edit($id){
        ...
        $this->template->view('master/front_office/editfront_office_v',$data);
    }
    ...
    public function simpanUpdate(){
        ...
        if($this->upload->do_upload('foto')) {
            ...
            if ($a) {
                $this->session->set_flashdata('success', 'Data Front Office berhasil update!');
                redirect('FrontOffice/listFrontOffice');
            }
        ...
        $this->session->set_flashdata('warning', 'Data Front Office gagal update!');
        redirect('FrontOffice/listFrontOffice');
    }

    public function delete_front_office($id){
        $data = array('is_active' => '0' );
        $delete = $this->MainModel->delete($table='user',$data,$id);
        if($delete){
            $this->session->set_flashdata('success', 'Data Front Office berhasil dihapus!');
            redirect('FrontOffice/listFrontOffice');
        }
        $this->session->set_flashdata('warning', 'Data Front Office gagal dihapus!');
        redirect('FrontOffice/listFrontOffice');
    }
}