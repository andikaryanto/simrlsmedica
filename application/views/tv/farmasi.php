            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">Antrian Farmasi Klinik Rajal</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-sm-12" style="margin-left: auto; margin-right: auto">
                <div class="box box-success">
                    <div class="box-header text-center" style="margin-top: 50px; padding-bottom: 50px">
                        ...
                        <h4>Antrian Farmasi Klinik Rajal</h4>
            ...
            <div class="col-sm-12 col-md-5 col-lg-4">
                <div class="box box-success">
                    <div class="box-header text-center">
                        ...
                        <h1><b id="ant-kode" style="font-size: 80px !important;"><?=$last_called->no_antrian ?? ''?></b></h1>
                        <div style="height: 40px"></div>
                        <hr>
...
<script>
    ...
    $(function () {
        let kode = '<?=$last_called ? $last_called->no_antrian : ""?>'.split('').join(' ... ')
    ...
    $(function () {
        ...
        socket.on('farmasi', function(msg) {
            ...
            const kode = no_antrian.replaceAll('-', '').split('').join(' ... ')
