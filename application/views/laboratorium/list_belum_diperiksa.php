                        ...
                        <table id="example2" class="table table-striped table-hover">
                            ...
                            <?php $no=1; foreach ($listPendaftaran as $row) { ?>
                                <tr>
                                    ...
                                    <td> <span class="pull-right-container"><small class="label pull-right bg-green text-uppercase"><?php echo ucwords(str_replace('_', ' ', $row->status)); ?></small></span></td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <a href="<?php  echo base_url(); ?>laboratorium/periksaAwal/<?php echo $row->id; ?>" class="btn btn-sm btn-block btn-warning" style="margin-bottom: 5px;" ><i class="fa fa-pencil"></i> Periksa</a>
                                                <a href="<?php echo base_url(); ?>laboratorium/hapus/<?php echo $row->id; ?>/listpemeriksaanPasien"
