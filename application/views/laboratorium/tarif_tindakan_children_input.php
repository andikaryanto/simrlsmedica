...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Data Tarif Dan Layanan <?=$parent->nama?>
            <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url() ?>Dashbord"><i class="fa fa-dashboard"></i> Dashbord</a></li>
            <li class="active">Tarif Dan Layanan <?=$parent->nama?></li>
        </ol>
    </section>
            ...
            <div class="col-md-6">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Tarif Dan Layanan <?=$parent->nama?></h3>
                    </div>
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post"
                              action="<?php echo base_url() ?>Laboratorium/simpanTarifDanLayananChildren">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="nama" class="col-sm-4 control-label" >Nilai Rujukan</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nilai_rujukan" name="nilai_rujukan" placeholder="Masukkan nilai rujukan" value="<?=isset($jenis_layanan_lab) ? $jenis_layanan_lab->nilai_rujukan : '' ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama" class="col-sm-4 control-label" >Satuan</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="satuan" name="satuan" placeholder="Masukkan satuan" value="<?=isset($jenis_layanan_lab) ? $jenis_layanan_lab->satuan : '' ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama" class="col-sm-4 control-label" >JM Owner</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="tarif_owner" name="tarif_owner" value="<?php echo $jenis_layanan_lab->tarif_owner ?>" onkeyup="set_tarifpasien()" placeholder="Masukkan JM Owner" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="kategori" class="col-sm-4 control-label">JM Klinik</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="klinik" name="klinik" value="<?php echo $jenis_layanan_lab->klinik ?>" onkeyup="set_tarifpasien()" placeholder="Masukkan tarif untuk klinik" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="tarif_lain" name="tarif_lain" value="<?php echo $jenis_layanan_lab->tarif_lain ?>" onkeyup="set_tarifpasien()" placeholder="Masukkan Sarpras" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="tarif_perawat" name="tarif_perawat" value="<?php echo $jenis_layanan_lab->tarif_perawat ?>" onkeyup="set_tarifpasien()" placeholder="Masukkan JM Perawat/Asisten" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama" class="col-sm-4 control-label" >JM Analis</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="tarif_analis" name="tarif_analis" value="<?php echo $jenis_layanan_lab->tarif_analis ?>" onkeyup="set_tarifpasien()" placeholder="Masukkan JM Analis" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="tarif_pasien" name="tarif_pasien" placeholder="masukkan nama total tarif pasien" required value="<?=isset($jenis_layanan_lab) ? $jenis_layanan_lab->tarif_pasien : 0 ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
