...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Riwayat Obat</a></li>
            <li class="active">Data Riwayat Obat</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Riwayat Obat</h5>
                        <hr/>

                        <form class="form-horizontal" method="get"
                              action="<?php echo base_url() ?>HistoryObat/riwayat">
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data List Riwayat Obat</h3>&nbsp;&nbsp;
                    ...
                    <div class="box-body">
                        ...
                        <table id="printable_table_e" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th rowspan="2" style="vertical-align: middle">Distributor</th>
                                <th rowspan="2" style="vertical-align: middle">Kadaluarsa</th>
                            ...
                            <?php $no=1; foreach ($data['data'] as $row) { ?>
                                ...
                                <tr>
                                    <td> <?php echo $no; ?></td>
                                    <td> <?php echo $row['obat']->nama; ?></td>
                                    <td> <?php echo $row['obat']->kategori; ?></td>
                                    <td> <?php echo $row['obat']->distributor; ?></td>
                                    <td> <?php echo $row['obat']->tanggal_kadaluwarsa; ?></td>
                                    <td nowrap style="text-align: right">Rp  <?php echo number_format($row['obat']->harga_jual, 2,',','.'); ?></td>
                                    <td nowrap style="text-align: right">Rp  <?php echo number_format($row['obat']->harga_beli, 2,',','.'); ?></td>
