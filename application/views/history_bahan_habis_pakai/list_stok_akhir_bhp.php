...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Data Stok Akhir Bahan Habis Pakai
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Stok Akhir Bahan Habis Pakai</a></li>
            <li class="active">Data Stok Akhir Bahan Habis Pakai</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Stok Akhir Bahan Habis Pakai</h5>
                        <hr/>

                        <form class="form-horizontal" method="get" action="<?php echo base_url() ?>HistoryBahanHabisPakai/stokAkhir">
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data List Stok Akhir Bahan Habis Pakai</h3>&nbsp;&nbsp;
                        ...
                        <table id="printable_table_e" class="table table-bordered table-hover">
                            ...
                            <?php $no=1; foreach ($data as $row) { ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right"> <?php echo $row->stok_akhir; ?></td>
                                </tr>
