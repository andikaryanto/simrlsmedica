...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Laporan Performa Dokter
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Laporan Performa Dokter</a></li>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Performa Dokter</h5>
                        <hr/>

                        <form class="form-horizontal" method="get"
                              action="<?php echo base_url() ?>Laporan/performaDokter">
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        <div class="box-body">
                            <div class="col-xs-<?=$jenis_pendaftaran ? '6' : '12'?>">
                                <div class="box-header">
                                    <h3 class="box-title">Data Performa Dokter</h3>&nbsp;&nbsp;
                                </div>
                                ...
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        $no = 1;
                                        if ($performa_dokter) {
                                            foreach ($performa_dokter->result() as $row) { ?>
                                                <tr>
                                                    <td> <?php echo $no; ?></td>
                            ...
                            <div class="col-xs-6 <?=$jenis_pendaftaran ? '' : 'hidden'?>">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Diagram Jumlah Performa Dokter</h3>
...
<script type="text/javascript">
    ...
    var bar_data = {
        data: [<?php $i = 1; foreach ($performa_dokter->result() as $key => $value): ?>["<?php echo $value->nama_dokter;?>",<?php echo $value->jumlah;?>]<?php echo ($performa_dokter->num_rows() == $i) ? "" : "," ?><?php $i++; endforeach ?>],
        color: '#3c8dbc'
    }
