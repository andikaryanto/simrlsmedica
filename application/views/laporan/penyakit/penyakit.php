    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penyakit</h5>
                        <hr/>

                        <form class="form-horizontal" method="get"
                              action="<?php echo base_url() ?>Laporan/Penyakit">
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        <div class="box-body">
                            <div class="col-xs-6">
                                <div class="box-header">
                                    <h3 class="box-title">Data Laporan Penyakit</h3>&nbsp;&nbsp;
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Diagram Jumlah Laporan Penyakit</h3>
...
<script type="text/javascript">
    var bar_data = {
        data: [<?php $i = 1; foreach ($penyakit->result() as $key => $value): ?>["<?php echo $value->nama;?>",<?php echo $value->jumlah;?>]<?php echo ($penyakit->num_rows() == $i) ? "" : "," ?><?php $i++; endforeach ?>],
        color: '#3c8dbc'
    }
