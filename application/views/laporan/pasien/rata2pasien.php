...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Laporan Rata - Rata Pasien
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Laporan Rata - Rata Pasien </a></li>
            <li class="active">Rata - Rata Pasien</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Rata - Rata Pasien </h5>
                        <hr/>
                        <form class="form-horizontal" method="get" action="<?php echo base_url() ?>Laporan/rata2Pasien">
                            <div class="row">
                                <div class="col-sm-4">
