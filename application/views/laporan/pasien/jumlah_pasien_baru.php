...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Laporan Jumlah Pasien Baru
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Laporan Jumlah Pasien Baru</a></li>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Jumlah Pasien Baru</h5>
                        <hr/>

                        <form class="form-horizontal" method="get"
                              action="<?php echo base_url() ?>Laporan/jumlahPasienBaru">
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        <div class="col-xs-6">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <?php
                                    $no = 1;
                                    if ($jumlah_pasien_baru) {
                                        foreach ($jumlah_pasien_baru->result() as $row) {
                                            if ($row->nama == $tipe_pasien || $tipe_pasien == '') { ?>
                                                <tr>
                                                    <td> <?php echo $no++; ?></td>
                                                    <td> <?php echo $jaminan[$row->nama]['label']; ?></td>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="printable_table" class="table table-bordered table-hover">
                            ...
                            <?php
                            $no = 1;
                            if ($list_jumlah_pasien_baru) {
                                foreach ($list_jumlah_pasien_baru as $row) { ?>
                                    <tr>
                                        <td> <?php echo $no; ?></td>
...
$label = array();
$data = array();
foreach ($jumlah_pasien_baru->result() as $item) {
    if ($item->nama == $tipe_pasien || $tipe_pasien == '') {
        $label[] = $item->nama;
