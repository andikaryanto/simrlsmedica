...
<div>
    <div style="display: flex">
        ...
        <div>Rekam Medis Poli Sunat</div>
...
<div style="width: 100%; display: flex; flex-direction: column; font-size: 12px; line-height: 120%; margin-top: 10px">
    <div class="flex">
        <div class="flex f1 b" style="align-items: center; justify-content: center">
            <h2 class="f1" style="text-align: center">PENGKAJIAN AWAL PASIEN POLI SUNAT</h2>
        </div>
    ...
    <div>
        <table style="margin-top: 0; font-size: 12px;">
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Anamnesa</strong></u>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <strong>Riwayat Pendarahan :</strong>
                    <?=$pemeriksaan['riwayat_pendarahan']?>
                </td>
            </tr>
            <tr>
                <td>
                    <strong>Penyakit Bawaan :</strong>
                    <?=$pemeriksaan['penyakit_bawaan']?>
                </td>
            </tr>
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Status Vitalis</strong></u>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Status Lokasi : Regio Genittala</strong></u>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Laporan Operasi</strong></u>
                </td>
            </tr>
            <tr>
                <td>
                    <strong>Anastesi : </strong>
                    <?=implode(', ', $form['anastesi'] ?? [])?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <strong>Teknik Operasi : </strong>
                    <?=implode(', ', $form['technique'] ?? [])?>
                </td>
            </tr>
            <tr>
                <td>
                    <strong>Tipe Jahitan : </strong>
                    <?=implode(', ', $form['technique'] ?? [])?>
                </td>
            </tr>
            <tr>
                <td>
                    <strong>Jumlah Jahitan : </strong>
                    <?=$form['jumlah_jahitan'] ?? ''?>
                </td>
            </tr>
            <tr>
            ...
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">POST OPERASI</strong></u>
                </td>
            </tr>
            <tr>
                <td>
                    <strong>Perawatan Di Rumah : </strong>
                    <?=$form['perawatan_di_rumah'] ?? ''?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Jadwal Perawatan</strong></u>
                </td>
            </tr>
            <tr>
                <td>
                    <strong>Perawatan Selanjutnya : </strong>
                    <?=$form['next'] ?? ''?>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <?=$form['tipe_layanan'] == '1' ? 'Home Visit' : 'On Site'?>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table style="margin-top: 0; font-size: 12px; line-height: 120%; transform: translateY(-1px)">
            <tr>
                <td style="width: 33.33%">
                    <p><?=$klinik->kota?>, <span style="color: #aaaaaa">.............................</span> Jam <span style="color: #aaaaaa">.........</span></p>
