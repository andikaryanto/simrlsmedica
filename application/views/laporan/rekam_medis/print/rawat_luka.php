...
<div>
    <div style="display: flex">
        ...
        <div>Rekam Medis Poli Rawat Luka</div>
...
<div style="width: 100%; display: flex; flex-direction: column; font-size: 12px; line-height: 120%; margin-top: 10px">
    <div class="flex">
        <div class="flex f1 b" style="align-items: center; justify-content: center">
            <h2 class="f1" style="text-align: center">PENGKAJIAN AWAL PASIEN POLI RAWAT LUKA</h2>
        </div>
    ...
    <div>
        <table style="margin-top: 0; font-size: 12px;">
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Wound Assesment Perdana Kusuma</strong></u>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Skor Perdanakusuma II Penilaian Luka Kronik</strong></u>
                </td>
            </tr>
            <tr style="background-color: #eeeeee">
                <td>
                    <u><strong style="font-size: 16px">Pengkajian Deteksi Vital</strong></u>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <strong>Perawatan Luka Selanjutnya : </strong>
                    <?=$form['next'] ?? ''?>
                </td>
            </tr>
            <tr>
