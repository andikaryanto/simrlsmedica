<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Data Retur Bahan Habis Pakai
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Master</a></li>
            <li class="active">Data Retur Bahan Habis Pakai</li>
        </ol>
    </section>
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="col-sm-8">
                            ...
                            <a href="<?php echo base_url(); ?>BahanHabisPakai/tambahRetur">
                        ...
                        <div class="col-sm-2 pull-right">
                            <form class="form-horizontal" method="post"
                                  action="<?php echo base_url() ?>export/bhp/retur">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="table-responsive">
                                                            ...
                                                            <p class="text-right">
                                                                <a href="<?= base_url() . 'BahanHabisPakai/editRetur/' . $row->id ?>"
