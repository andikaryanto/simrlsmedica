...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Edit Input Bahan Habis Pakai
            <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url() ?>Dashbord"><i class="fa fa-dashboard"></i> Dashbord</a></li>
            <li class="active">Edit Input Bahan Habis Pakai</li>
        </ol>
    </section>

    <!-- Main content -->
    <form class="form-horizontal" method="post" action="<?php echo base_url()?>BahanHabisPakai/editInput/<?=$input->id?>">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="tgl_digunakan" value="<?=date('Y-m-d', strtotime($input->tgl_digunakan))?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="jumlah" id="jumlah" value="<?=$input->jumlah?>" placeholder="Masukkan Jumlah" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="tujuan" class="col-sm-4 control-label">Satuan</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="satuan" id="satuan" value="<?=$input->satuan?>" placeholder="Masukkan Satuan" readonly>
                                </div>
                            </div>
                        </div>
