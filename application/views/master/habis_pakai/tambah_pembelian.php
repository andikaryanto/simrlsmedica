                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <button type="button" id="b-new-bahan" class="btn btn-sm btn-success"><i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
...
<!--                                        </div>-->
                                        ...
                                        <div class="form-group" id="c-umum">
                                            <label for="harga_jual" class="col-sm-4 control-label" style="font-size: small">Harga Jual </label>
                                            <div class="col-sm-8">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Buat BHP</h4>
            </div>
...
<script>
    $(function () {
        ...
        $('#b-save-obat').click(function () {
            $.ajax({
                type: "POST",
                url: '<?=base_url()?>BahanHabisPakai/ajax_create',
