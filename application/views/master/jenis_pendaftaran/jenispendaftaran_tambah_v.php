                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" method="post"
                              action="<?php echo base_url() ?>JenisPendaftaran/simpanTambah">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nama" name="nama"
                                                       placeholder="Masukkan nama jenis pendaftaran pasien" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="kode" name="kode"
                                                       placeholder="Masukkan kode jenis pendaftaran pasien" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url() ?>JenisPendaftaran"
