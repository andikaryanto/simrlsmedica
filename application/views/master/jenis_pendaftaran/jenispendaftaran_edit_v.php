 ...
 <div class="content-wrapper">
   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Edit Jenis Pendaftaran Pasien
        <small>Preview</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() ?>Dashbord"><i class="fa fa-dashboard"></i> Dashbord</a></li>      
        <li class="active">Edit Jenis Pendaftaran Pasien</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Edit Jenis Pendaftaran Pasien</h3>
            </div>
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
             <form class="form-horizontal" method="post" action="<?php echo base_url()?>JenisPendaftaran/simpanUpdate">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $jenis_pendaftaran->nama; ?>" placeholder="Masukkan nama jenis pendaftaran pasien">
                          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $jenis_pendaftaran->id; ?>" placeholder="Masukkan id jenis pendaftaran pasien">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="nama" class="col-sm-4 control-label" >Kode</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $jenis_pendaftaran->kode; ?>" placeholder="Masukkan kode jenis pendaftaran pasien">
                        </div>
                      </div>
                    </div>
                  </div>  
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url() ?>JenisPendaftaran"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
              </div>
              <!-- /.box-footer -->
            </form>
