            ...
            <div class="col-md-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Date dd/mm/yyyy -->
                        <form class="form-horizontal" method="post" action="<?php echo base_url()?>Apotek/editPembelianObat/<?=$pembelian->id?>/<?=$obat->id?>">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" class="form-control" id="jumlah_lama" name="jumlah_lama" value="<?=$jumlah?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="stok_obat" class="col-sm-4 control-label">Jumlah</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="jumlah_baru" value="<?php echo $jumlah; ?>" name="jumlah_baru" placeholder="Masukkan jumlah">
                                            </div>
                                        </div>
                                    </div>
                                </div>
