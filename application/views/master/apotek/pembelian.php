                ...
                <div class="box">
                    <div class="box-header">
                        <div class="col-sm-8">
                            ...
                            <a href="<?php echo base_url(); ?>Apotek/tambahPembelianObat">
                                <button type="button" class="btn btn-primary"><span
                                            class="glyphicon glyphicon-plus"></span></button>
                            </a>
<!--                            <a href="--><?php //echo base_url(); ?><!--Apotek/settingPersenPembelian">-->
...
<!--                            </a>-->
                        ...
                        <div class="col-sm-2 pull-right">
                            <form class="form-horizontal" method="post"
                                  action="<?php echo base_url() ?>export/apotek/pembelian">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="table-responsive">
                                                            ...
                                                            <p class="text-right">
                                                                <a href="<?= base_url() . 'Apotek/editPembelianObat/' . $row->id ?>"
