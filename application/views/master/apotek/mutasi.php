                ...
                <div class="box box-default">
                    <div class="box-header">
                        <div class="col-sm-8">
                            ...
                            <a href="<?php echo base_url(); ?>Apotek/tambahMutasiObat" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Mutasi</a>
                        </div>
                        <div class="col-sm-2 pull-right">
                            <form class="form-horizontal" method="post" action="<?php echo base_url()?>export/apotek/mutasi">
                            ...
                            <table id="example2" class="table table-striped table-hover">
                                ...
                                <?php foreach ($mutasi as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= ($value->jumlah < 0 ? (-1 * $value->jumlah) : $value->jumlah) ?></td>
                                        <td><?= $value->tujuan ?></td>
