<?php
if ($is_edit) {
    $list_obat = unserialize($retur->list_obat);
}
?>
        ...
        <div class="row">
            <div class="col-md-3">
                <form class="form-horizontal" method="post"
                      action="<?php echo base_url() ?>Apotek/<?= ($is_edit ? 'editReturObat' : 'tambahReturObat') ?>">
                    <input type="hidden" name="id_transaksi" value="<?= ($is_edit ? $retur->id : 0) ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="no_faktur" name="no_faktur"
                                           ...
                                           value="<?= ($is_edit ? $retur->no_faktur : '') ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" class="form-control" id="tgl_faktur" name="tgl_faktur"
                                           ...
                                           value="<?= ($is_edit ? date('Y-m-d', strtotime($retur->tgl_faktur)) : '') ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" class="form-control" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo"
                                           value="<?= ($is_edit ? date('Y-m-d', strtotime($retur->tgl_jatuh_tempo)) : '') ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="nama_distributor"
                                           ...
                                           value="<?= ($is_edit ? $retur->nama_distributor : '') ?>"
                    ...
                    <div id="hiddenFormObat">
                        ...
                        <input type="hidden" name="total" value="<?= ($is_edit ? $retur->total : 0) ?>">
                            ...
                            <table class="table table-striped table-obat">
                                ...
                                <tr class="calculate">
                                    ...
                                    <td class="text-right total">
                                        Rp <?= number_format($retur->total ?? 0, 2, ',', '.') ?></td>
                                    <td></td>
                                </tr>
