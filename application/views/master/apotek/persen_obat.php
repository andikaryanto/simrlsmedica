        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-danger">
                    ...
                    <?php } ?>
                    <form class="form-horizontal" method="post" action="<?php if ($is_pembelian) echo base_url() . 'Apotek/settingPersenPembelian'; else echo base_url() . 'Apotek/settingPersen'; ?>">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php if ($is_pembelian) echo base_url() . 'Apotek/pembelian'; else echo base_url() . 'Apotek/stokObat'; ?>"
