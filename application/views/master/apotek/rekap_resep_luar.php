                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="printable_table" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; $diskon = 0; $total = 0; $obat_ = 0; $racik = 0; $jasa = 0; $ongkir = 0; $jumlah = 0;?>
                            <?php foreach ($penjualan as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php $harga3 = 0; ?>
                                        <?php if($racikan) : ?>
                                            <?php foreach ($racikan as $row3) : ?>
                                                <?php if($row->id == $row3->penjualan_obat_luar_id) : ?>
                                                    <?php $harga3 += $row3->total; ?>
                                                <?php endif; ?>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    ...
                                    <td><?='Rp '.number_format($row->biaya_ongkir,2,',','.')?></td>
                                ...
                                <?php $no++; $diskon += $row->diskon; $total += $row->total; $jumlah += $row->jumlah; $jasa += $row->jasa_racik; $ongkir += $row->biaya_ongkir; $obat_ += $harga2; $racik += $harga3; ?>
                                <?php endforeach; ?>
                            </tbody>
                            <tfoot>
                            <tr>
                                ...
                                <th></th>
                                <th></th>
                                <th><?='Rp '.number_format($obat_,2,',','.')?></th>
                                <th><?='Rp '.number_format($racik,2,',','.')?></th>
                                <th><?='Rp '.number_format($jasa,2,',','.')?></th>
                                <th><?='Rp '.number_format($ongkir,2,',','.')?></th>
                                <th><?='Rp '.number_format($jumlah,2,',','.')?></th>
