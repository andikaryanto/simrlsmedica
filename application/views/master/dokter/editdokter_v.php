            ...
            <div class="col-md-12">
                <div class="box box-danger">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data"
                          action="<?=base_url()?>Dokter/simpanUpdate">
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="hidden" class="form-control" id="id" name="id"
                                                   value="<?=$user->id;?>" placeholder="Masukkan nama">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="id_jenis_pendaftaran" required>
                                                <?php foreach ($jenis_pendaftaran as $k => $v) {?>
                                                    <option value="<?=$v->id?>" <?=$v->id == $user->id_jenis_pendaftaran ? 'selected' : ''?>><?=$v->nama;?></option>
                                                <?php }?>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?=base_url()?>Dokter" class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
