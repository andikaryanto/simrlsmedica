                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post"
                              action="<?php echo base_url() ?>Dokter/simpan_adddokter">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="nama" class="col-sm-4 control-label">SIP</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="sip" name="sip" value=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="username" name="username"
                                                       value="" placeholder="Masukkan username" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="telepon" name="telepon"
                                                       value="" placeholder="Masukkan telepon dokter" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nama_grup" name="nama_grup"
                                                       value="Dokter" required readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputtext3" class="col-sm-4 control-label">Pilih Poli</label>
                                            <div class="col-sm-4">
                                                <select class="form-control" name="id_jenis_pendaftaran" required>
                                                    <?php foreach ($jenis_pendaftaran as $key => $value) { ?>
