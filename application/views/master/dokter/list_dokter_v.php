            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo base_url(); ?>Dokter/addDokter">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            foreach ($listDokter->result() as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>Dokter/edit/<?php echo $row->id; ?>">
                                        ...
                                        <a onclick="return confirm('Apakah Anda ingin menghapus data ini?');"
                                           href="<?php echo base_url(); ?>Dokter/delete_dokter/<?php echo $row->id; ?>">
