        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-danger">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>AdminKeuangan/simpanUpdate">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $user->nama; ?>"  placeholder="Masukkan nama admin keuangan">
                                            <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $user->id; ?>"  placeholder="Masukkan nama admin keuangan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="telepon" name="telepon" value="<?php echo $user->telepon; ?>"  placeholder="Masukkan telepon admin keuangan">
                                        </div>
                                    </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo base_url() ?>AdminKeuangan"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
