   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Data Shift</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
           <form class="form-horizontal" method="post" action="<?php echo base_url()?>Insentif/simpanUpdateShift">
              <div class="box-body">
               <div class="row">
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="shift" name="shift" value="<?php echo $list_shift->shift ?>" readonly>
                          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $list_shift->id ?>" placeholder="Masukkan nama">
                        </div>
                      </div>
                     
                      </div>
                       <div class="form-group">
                        <label for="nama" class="col-sm-4 control-label" >Insentif Shift</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="insentif" name="insentif" value="<?php echo $list_shift->insentif ?>" placeholder="Masukkan insentif">
              ...
              <div class="box-footer">
                <button type="submit"  name="submit" value="1" class="btn btn-primary btn-lg btn-flat pull-right">Simpan</button>
                  <a href="<?php echo base_url() ?>Insentif/listInsentifShift"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
              </div>
              <!-- /.box-footer -->
            </form>
