                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post"
                              action="<?php echo base_url() ?>Perawat/simpan_addperawat">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nama" name="nama" value=""
                                                       placeholder="Masukkan nama perawat" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="telepon" name="telepon"
                                                       value="" placeholder="Masukkan telepon perawat" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nama_grup" name="nama_grup"
                                                       value="Perawat" required readonly="readonly">
                                            </div>
                                        </div>
                                    </div>
                                </div>
