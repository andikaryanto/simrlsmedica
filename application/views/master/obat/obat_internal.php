...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Laporan Obat Internal
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Laporan Obat Internal</a></li>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Obat Internal</h5>
                        <hr/>

                        <form class="form-horizontal" method="get" action="<?php echo base_url() ?>Laporan/obat_obat_internal">
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        <div class="box-body">
                            <div class="col-xs-6">
                                <div class="box-header">
                                    <div class="col-sm-8">
                                        <h3 class="box-title">Data Obat Internal</h3>&nbsp;&nbsp;
                                    </div>
                                    <div class="col-sm-2 pull-right">
                                        <form class="form-horizontal" method="post" action="<?php echo base_url()?>ExportExcelLaporan/obat_obat_internal">
                            ...
                            <div class="col-xs-6">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Diagram Obat Internal</h3>
