        ...
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
             <form class="form-horizontal" method="post" action="<?php echo base_url()?>pendaftaran/surat_sehat">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url() ?>pendaftaran/listPendaftaranPasien"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
              </div>
              <!-- /.box-footer -->
            </form>
