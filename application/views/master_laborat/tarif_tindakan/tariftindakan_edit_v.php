        ...
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
           <form class="form-horizontal" method="post" action="<?php echo base_url()?>masterlaborat/simpanUpdateTindakan">
              <div class="box-body">
               <div class="row">
                  <div class="col-md-12">
              ...
              <div class="box-footer">
                <button type="submit"  name="submit" value="1" class="btn btn-primary btn-lg btn-flat pull-right">Simpan</button>
                  <a href="<?php echo base_url() ?>masterlaborat/listtariftindakan"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
              </div>
              <!-- /.box-footer -->
            </form>
