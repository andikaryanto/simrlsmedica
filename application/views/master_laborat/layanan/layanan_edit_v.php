   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Data Layanan</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
           <form class="form-horizontal" method="post" action="<?php echo base_url()?>masterlaborat/simpanUpdate">
              <div class="box-body">
               <div class="row">
                  <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $layanan->kode ?>" placeholder="Masukkan kode">
                          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $layanan->id ?>" placeholder="Masukkan nama">
                        </div>
                      </div>
                     
                      </div>
                       <div class="form-group">
                        <label for="nama" class="col-sm-4 control-label" >Nama Layanan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $layanan->nama ?>" placeholder="Masukkan nama">
              ...
              <div class="box-footer">
                <button type="submit"  name="submit" value="1" class="btn btn-primary btn-lg btn-flat pull-right">Simpan</button>
                  <a href="<?php echo base_url() ?>masterlaborat/listlayanan"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
              </div>
              <!-- /.box-footer -->
            </form>
