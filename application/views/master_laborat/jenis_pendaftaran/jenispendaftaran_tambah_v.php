 ...
 <div class="content-wrapper">
   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Tambah Jenis Pendaftaran Pasien
        <small>Preview</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() ?>Dashbord"><i class="fa fa-dashboard"></i> Dashbord</a></li>      
        <li class="active"> Tambah Jenis Pendaftaran Pasien</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title"> Tambah Jenis Pendaftaran Pasien</h3>
            </div>
            ...
            <div class="box-body"> 
              ...
              <!-- Date dd/mm/yyyy -->
             <form class="form-horizontal" method="post" action="<?php echo base_url()?>JenisPendaftaran/simpanTambah">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama jenis pendaftaran pasien" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="nama" class="col-sm-4 control-label" >Kode</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan kode jenis pendaftaran pasien" required>
                        </div>
                      </div>
                    </div>
                  </div>  
