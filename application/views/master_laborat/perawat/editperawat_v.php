        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-danger">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>Perawat/simpanUpdate">  
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo base_url() ?>Perawat"  class="btn btn-default btn-lg btn-flat pull-right">Batal</a>
                    </div>
                    <!-- /.box-footer -->
                    </form> 
                </div>
