...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Stok Awal Obat</a></li>
            <li class="active">Data Stok Awal Obat</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Stok Awal Obat</h5>
                        <hr/>

                        <form class="form-horizontal" method="get" action="<?php echo base_url() ?>HistoryObat/stokAwal">
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data List Stok Awal Obat</h3>&nbsp;&nbsp;
