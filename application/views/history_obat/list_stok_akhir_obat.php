...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Data Stok Akhir Obat
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Stok Akhir Obat</a></li>
            <li class="active">Data Stok Akhir Obat</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-body">
                        <h5><i class='fa fa-file-text-o fa-fw'></i> Stok Akhir Obat</h5>
                        <hr/>

                        <form class="form-horizontal" method="get" action="<?php echo base_url() ?>HistoryObat/stokAkhir">
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data List Stok Akhir Obat</h3>&nbsp;&nbsp;
