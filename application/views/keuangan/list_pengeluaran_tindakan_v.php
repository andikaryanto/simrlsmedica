            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"> Pengeluaran Tindakan</h3>&nbsp;&nbsp;
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=1; foreach ($tindakan->result() as $row) { ?>
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo number_format(($row->klinik+$row->tarif_lain+$row->tarif_dokter+$row->tarif_perawat),2,',','.'); ?></td>
