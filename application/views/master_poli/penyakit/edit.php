        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-danger">
                    ...
                    <?php } ?>
                    <div class="box-body">
                        <form class="form-horizontal" method="post" action="<?php echo base_url()?>MasterPoli/simpanUpdate">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="kode" name="kode"  placeholder="Masukkan kode" required value="<?=$penyakit->kode?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nama" name="nama"  placeholder="Masukkan nama penyakit" required value="<?=$penyakit->nama?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
