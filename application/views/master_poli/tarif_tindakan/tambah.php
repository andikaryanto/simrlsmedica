        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-danger">
                    ...
                    <?php } ?>
                    <div class="box-body">
                        <form class="form-horizontal" method="post" action="<?php echo base_url()?>MasterPoli/tambah_TarifTindakan">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="jm_admin" name="jm_admin"  value="0" onkeyup="set_tarifpasien()" placeholder="Masukkan tarif untuk klinik" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="kategori" class="col-sm-4 control-label">Pajak</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="pajak" name="pajak"  value="0" onkeyup="set_tarifpasien()" placeholder="Masukkan tarif untuk klinik" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="kategori" class="col-sm-4 control-label">Zakat</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="zakat" name="zakat"  value="0" onkeyup="set_tarifpasien()" placeholder="Masukkan tarif untuk klinik" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="kategori" class="col-sm-4 control-label">BHP</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bhp" name="bhp"  value="0" onkeyup="set_tarifpasien()" placeholder="Masukkan tarif untuk klinik" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
