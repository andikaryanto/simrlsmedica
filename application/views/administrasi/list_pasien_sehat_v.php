...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">List Pasien Surat Sehat</a></li>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data Pasien Surat Sehat</h3>&nbsp;&nbsp;
                            ...
                            foreach ($listPemeriksaan->result() as $row) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="pull-right-container"><small
                                                    class="label pull-right bg-green"><?php echo ucwords($row->status); ?></small></span>
                                    </td>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url(); ?>Administrasi/surat_sehat_print/<?php echo $row->id; ?>" target="_blank">
